...
- **Product Managers** looking for structured frameworks to drive clarity
- **Product Leaders** building or scaling product organizations
- **Founders & Entrepreneurs** needing proven methodologies for product development
- **Innovation Teams** exploring new opportunities systematically
- **AI Product Managers** navigating the unique challenges of AI-native products
...
- End-to-End Innovation Framework (proprietary)
- Product Canvas & Vision Board
- OKR Templates & Goal-Setting Frameworks
- Product Roadmap Strategy Workbook
- North Star Metrics & KPI Frameworks

### 🔷 **Innovation & Ideation**
- Corporate Innovation Canvas
- Innovation Pyramid Questions
- Idea Validation Checklist
- Brainstorm Cards & Thinking Canvases
...
- Empathy Map Canvas
- UX Research Study Plans
- Customer Interview Toolbox

### 🔷 **Business Models & Value Propositions**
- Business Model Canvas (multiple formats)
...
- Product Survival Kit (Roadmap & Prioritization)
...
📁 **Location:** `/05-prioritization-tools/product-hypothesis-scoring.xlsx`

### 🎨 Corporate Innovation Canvas
A structured approach to corporate innovation covering:
- Innovation Ambition
- Strategic Alignment
- Resource Allocation
...
Start with the **Product Canvas** and **Customer Journey Map** to build clarity on your product vision and user needs.

### For Product Leaders
Explore the **Team Alignment Maps** and **OKR Frameworks** to drive organizational alignment.

### For Founders
Begin with the **Business Model Canvas** and **Value Proposition Canvas** to validate your business idea.
...
These frameworks have been influenced by:
- Strategyzer (Business Model Canvas, Value Proposition Canvas)
- Roman Pichler (Product Canvas, Product Vision Board)
